mergeInto(LibraryManager.library, {
    InstallSocketIO: function () {
        !function (t, e) {
            ...
            var d = /^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/, y = [
                    'source',
                    'protocol',
                    'authority',
                    'userInfo',
            ...
            var D, I = 'function' == typeof ArrayBuffer, F = function (t, e) {
                    ...
                    if (I) {
                        var n = function (t) {
                                var e, n, r, o, i, s = 0.75 * t.length, a = t.length, c = 0;
            ...
            var tt = null != new b({ xdomain: !1 }).responseType, et = function (t) {
                    i(s, t);
                    var n = h(s);
                    function s(t) {
                        var r;
                    ...
                    return r(a, [
                        {
                            ...
                            value: function (t) {
                                var e;
                                if ('string' == typeof t)
                                    (e = this.decodeString(t)).type === bt.BINARY_EVENT || e.type === bt.BINARY_ACK ? (this.reconstructor = new Et(e), 0 === e.attachments && f(s(a.prototype), 'emitReserved', this).call(this, 'decoded', e)) : f(s(a.prototype), 'emitReserved', this).call(this, 'decoded', e);
                                else {
                                    if (!dt(t) && !t.base64)
            ...
            function St(t) {
                t = t || {}, this.ms = t.min || 100, this.max = t.max || 10000, this.factor = t.factor || 2, this.jitter = t.jitter > 0 && t.jitter <= 1 ? t.jitter : 0, this.attempts = 0;
            }
            ...
            var Bt = function (n) {
                    ...
                    function s(n, r) {
                        var i, a;
                        e(this, s), (i = o.call(this)).nsps = {}, i.subs = [], n && 'object' === t(n) && (r = n, n = void 0), (r = r || {}).path = r.path || '/socket.io', i.opts = r, A(c(i), r), i.reconnection(!1 !== r.reconnection), i.reconnectionAttempts(r.reconnectionAttempts || 1 / 0), i.reconnectionDelay(r.reconnectionDelay || 1000), i.reconnectionDelayMax(r.reconnectionDelayMax || 5000), i.randomizationFactor(null !== (a = r.randomizationFactor) && void 0 !== a ? a : 0.5), i.backoff = new Ot({
                            min: i.reconnectionDelay(),
                            max: i.reconnectionDelayMax(),
                            jitter: i.randomizationFactor()
                        }), i.timeout(null == r.timeout ? 20000 : r.timeout), i._readyState = 'closed', i.uri = n;
                        var u = r.parser || At;
